...
#         item1 = types.KeyboardButton("Web")
#         item2 = types.KeyboardButton("Contact us")
#         markup.add(item1, item2)
#
#         bot.send_message(message.from_user.id, "Choose button", parse_mode = 'html', reply_markup = markup)
#
#         if message.text == 'Web':
#                 bot.send_message(message.chat.id, 'https://kinosfera-imax.ru/#/')
#         elif message.text == 'Contact us':
#                 bot.send_message(message.chat.id, 'https://www.imax.com/content/contacts')
#         else:
